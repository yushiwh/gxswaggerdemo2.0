...
public interface CityService {
     ...
     * @return
     */
    @ApiOperation(value = "根据城市 ID,查询城市信息---直接注解", notes = "根据城市 ID,查询城市信息---直接注解")
    @ApiImplicitParam(name = "id", value = "城市ID", paramType = "path", required = true, dataType = "Long")
    @RequestMapping(value = "/zjsql/{id}", method = RequestMethod.GET)
    City findCityById_Zj(@PathVariable Long id);
